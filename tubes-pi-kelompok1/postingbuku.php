        ...
        <li class="nav-item rounded">
          <a class="nav-link" aria-current="page" href="beranda.php"><i class="bi bi-house-fill me-2"></i>Home</a>
				...
				<?php
					...
					<li class="nav-item rounded">
        	  <a class="nav-link active" href="#"><i class="bi bi-plus-square me-2"></i>Posting Buku</a>
        	</li>
        	<li class="nav-item rounded">
    ...
    <div class="content">
      ...
      <form action="post_buku.php" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control mb-4" name="stok_buku" placeholder="Masukkan Stok">
        </div>
				<button type="submit" class="btn btn-primary mb-3" name="submit">Tambah Baru</button>
			</form>
    </div>
  </div>
</body>
