        ...
        <li class="nav-item rounded">
          ...
          <a class="nav-link" href="daftarbuku.php"><i class="bi bi-list-ul me-2"></i>Daftar Buku</a>
				...
				<?php 
					...
					?>
					<li class="nav-item rounded">
        	  <a class="nav-link active" href="pinjambuku.php"><i class="bi bi-plus-square me-2"></i>Pinjam Buku</a>
        	</li>
					<li class="nav-item rounded">
	...
	<div class="container">
      ...
      <div class="div-center2">
       ...
       <hr />
         ...
         <button type="submit" class="btn btn-success mb-3" name="submit" onclick="return confirm('Apa anda yakin ingin meminjam?');">Pinjam Buku</button>
       </form>
     </div>
