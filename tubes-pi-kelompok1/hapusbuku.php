        ...
        <a class="nav-link" aria-current="page" href="beranda.php"><i class="bi bi-house-fill me-2"></i>Home</a>
      	...
      	<li class="nav-item rounded">
      	  <a class="nav-link" href="editbuku.php"><i class="bi bi-pencil-square me-2"></i>Edit Buku</a>
				...
				<li class="nav-item rounded">
      	  <a class="nav-link active" href="hapusbuku.php"><i class="bi bi-trash3 me-2"></i>Hapus Buku</a>
      	</li>
			<?php
				}
			?>
...
<div class="container">
      ...
      <hr />
			<div class="form-group">
					...
					<input type="text" class="form-control mb-3" name="id_buku" placeholder="Masukkan id buku yang ingin dihapus">
			</div>
		<button type="submit" class="btn btn-danger mb-3" name="submit" onclick="return confirm('Apa anda yakin ingin menghapus?');">Hapus Buku</button>
			</form>
		</div>
</body>
</html>